...
function filtrar() {
    router.get('/maquinas/baja-fisica', { pais: pais.value }, { preserveScroll: true });
}
...
function confirmarEliminar(row: Record<string, any>) {
    confirmToggle(
        ...
        () => ejecutarEliminar(row.IdMaquina),
    );
}

async function ejecutarEliminar(idMaquina: number) {
    try {
            ...
            <div class="mx-auto max-w-[1900px] px-2 py-4 sm:px-4 sm:py-6">
                ...
                <div class="mb-4 grid grid-cols-3 gap-3">
                    ...
                    <div class="rounded-xl border border-red-200 bg-red-50 p-4">
                        <p class="text-[10px] tracking-wider text-red-600 uppercase">Baja Física</p>
                ...
                <p v-if="!datos.length" class="py-16 text-center text-slate-400">
                    No hay máquinas en baja física para {{ paisNombre[pais] || pais }}.
                </p>
            </div>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400">Activar para que aparezca en reportes</p>
                        </div>
