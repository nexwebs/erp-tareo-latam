    ...
    <div class="min-h-screen bg-[#080c18] font-sans text-white">
        <div class="mx-auto max-w-[1700px] px-4 py-6">
            ...
            <div class="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                <div
                    class="rounded-xl border border-orange-900/50 bg-orange-900/20 p-4"
                >
                    <p class="text-xs tracking-wider text-orange-600 uppercase">
                        Total
                    </p>
                    <p class="mt-1 text-2xl font-black text-orange-400">
                        {{ fmt(totalGeneral) }}
                    </p>
                </div>
                <div
                ...
                <table class="w-full min-w-max border-collapse text-sm">
                    <thead>
                        <tr class="border-b border-slate-800">
                            ...
                            <th
                                class="border-r border-slate-800 bg-orange-950/40 px-3 py-3 text-center text-[10px] font-bold tracking-widest text-orange-500 uppercase"
                            >
                                Total
                            </th>
                            <th
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td
                                class="border-r border-slate-800 bg-orange-950/20 px-3 py-2 text-right text-xs font-bold text-orange-400 tabular-nums"
                            >
                                {{ fmt(row.total) }}
                            </td>
                            <td
                    ...
                    <tfoot>
                        <tr class="border-t-2 border-slate-700 bg-slate-800/60">
                            ...
                            <td
                                class="border-r border-slate-700 bg-orange-950/40 px-3 py-3 text-right text-sm font-black text-orange-300 tabular-nums"
                            >
                                {{ fmt(totalGeneral) }}
                            </td>
                            <td
