            ...
            <div class="w-full px-2 py-4 sm:px-4 sm:py-6">
                ...
                >
                    <div>
                        ...
                        >
                            Reporte
                            <span class="text-rose-500">por Centro</span>
                        </h1>
                ...
                <div class="mb-4 grid grid-cols-2 gap-3 sm:mb-6 sm:grid-cols-4">
                    ...
                    <div class="rounded-xl border border-rose-200 bg-rose-50 p-3 sm:p-4">
                        <p class="text-[10px] tracking-wider text-rose-600 uppercase sm:text-xs">
                            Total
                        </p>
                        <p class="mt-1 text-xl font-black text-rose-600 sm:text-2xl">
                            {{ fmt(totalGeneral) }}
                        </p>
                    </div>
                ...
                <div class="relative">
                    ...
                    <button
                        ...
                        class="absolute right-2 top-1/2 z-30 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full border border-rose-200 bg-white shadow-md text-lg text-rose-400 hover:text-rose-600 hover:border-rose-300 transition-all active:scale-95 animate-pulse"
                        ...
                        >
                            ...
                            <thead style="position: sticky; top: 0; z-index: 25">
                                <tr class="border-b border-slate-200 bg-white">
                                    ...
                                    <th class="bg-rose-50 px-3 py-3 text-center text-[10px] font-bold tracking-widest whitespace-nowrap text-rose-600 uppercase">
                                        Total
                                    </th>
                            ...
                            <tfoot style="position: sticky; bottom: 0; z-index: 25">
                                <tr class="border-t-2 border-slate-200 bg-slate-50">
                                    ...
                                    <td class="bg-rose-50 px-3 py-3 text-right text-sm font-black whitespace-nowrap text-rose-600 tabular-nums">
                                        {{ fmt(totalGeneral) }}
                                    </td>
