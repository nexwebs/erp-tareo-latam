            ...
            <div class="mx-auto max-w-[1700px] px-2 py-4 sm:px-4 sm:py-6">
                ...
                >
                    <div>
                        ...
                        >
                            Reporte
                            <span class="text-red-600">por Centro</span>
                        </h1>
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <input
                            v-model="fecha"
                            type="date"
                            class="rounded-lg border border-slate-700 bg-white/80 px-3 py-2 text-sm text-slate-700 focus:border-rose-500 focus:outline-none"
                        />
                        <button
                            @click="filtrar"
                            class="rounded-lg bg-rose-600 px-4 py-2 text-sm font-bold text-slate-700 transition hover:bg-rose-500 active:scale-95"
                        >
                            Filtrar
                        </button>
                        <button
                ...
                <div class="mb-3">
                    <input
                        ...
                        class="w-full rounded-xl border border-slate-700 bg-white/60 px-4 py-2.5 text-sm text-slate-700 placeholder-slate-600 focus:border-rose-500 focus:outline-none sm:w-80 sm:py-3"
                    />
                </div>
                    ...
                    <table class="w-full border-collapse text-sm">
                        ...
                        <thead>
                            <tr class="border-b border-slate-200">
                                ...
                                <th
                                    class="min-w-[80px] border-r border-slate-200 bg-rose-950/40 px-3 py-3 text-center text-[10px] font-bold tracking-widest text-rose-500 uppercase"
                                >
                                    Total
                                </th>
                                <th
