...
const fmtInt = (v: number) => new Intl.NumberFormat('es-PE').format(v || 0);
        ...
        <div class="min-h-screen bg-[#080c18] font-sans text-white">
            <div class="mx-auto max-w-[1400px] px-4 py-6">
                ...
                >
                    <div>
                        <p
                            class="mb-1 text-xs font-semibold tracking-[0.2em] text-violet-400 uppercase"
                        >
                ...
                <div class="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
                    ...
                    >
                        ...
                        <p class="mt-1 text-2xl font-black text-emerald-400">
                            {{ fmt(totales?.total_general ?? 0) }}
                        </p>
                    </div>
                    <div
                        class="rounded-xl border border-violet-900/50 bg-violet-900/20 p-4"
                    >
                        <p
                            class="text-xs tracking-wider text-violet-500 uppercase"
                        >
                            Registros
                        </p>
                    ...
                    <table class="w-full border-collapse text-sm">
                        <thead>
                            <tr class="border-b border-slate-800">
                                ...
                                <th
                                    class="px-3 py-3 text-right text-[10px] font-bold tracking-widest text-amber-600 uppercase"
                                >
                                    Promedio/h
                                </th>
                                <th
                                    class="px-3 py-3 text-right text-[10px] font-bold tracking-widest text-emerald-600 uppercase"
                                >
                                    Total
                                </th>
                                <th
                                    class="px-3 py-3 text-[10px] font-bold tracking-widest text-slate-600 uppercase"
                                >
                                    Distribución
                                </th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td
                                    class="max-w-[180px] truncate px-3 py-2 text-xs text-slate-300"
                                >
                                    {{ row.NombreCentro }}
                                </td>
                                ...
                                <td
                                    class="px-3 py-2 text-center font-mono text-xs text-cyan-400"
                                >
                                    {{ row.CodigoMaquina }}
                                </td>
                                <td
                                ...
                                <td
                                    class="px-3 py-2 text-right text-xs font-semibold text-amber-400 tabular-nums"
                                >
                                    {{ fmt(row.promedio) }}
                                </td>
                                <td
                                    class="px-3 py-2 text-right text-xs font-bold text-emerald-400 tabular-nums"
                                >
                                    {{ fmt(row.total) }}
                                </td>
                                <td class="px-3 py-2">
                                    <div
                                        class="h-1.5 w-full min-w-[80px] overflow-hidden rounded-full bg-slate-800"
                                    >
                                        <div
                        ...
                        <tfoot>
                            ...
                            >
                                ...
                                <td
                                    class="px-3 py-3 text-right text-xs font-black text-amber-300 tabular-nums"
                                >
                                    {{ fmt(promedioMostrado) }}
                                </td>
                                <td
                                    class="px-3 py-3 text-right text-sm font-black text-emerald-300 tabular-nums"
                                >
                                    {{ fmt(totalMostrado) }}
                                </td>
                                <td />
