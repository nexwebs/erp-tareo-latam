...
const horas = Array.from({ length: 8 }, (_, i) => i + 8);
...
const promedioGeneral = computed(() => {
    ...
    return totalGeneral.value / props.datos.length;
});
    ...
    <div class="min-h-screen bg-slate-900 px-4 py-6">
        <div class="mx-auto max-w-[1600px]">
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-white">Producción Perú</h1>
                    <p class="text-slate-400">Reporte por Centro Comercial</p>
                </div>
                ...
                <table class="w-full min-w-[1200px]">
                    <thead>
                        <tr class="bg-slate-800/80">
                            ...
                            <th class="border-b bg-amber-900/50 px-3 py-2 text-center text-xs font-bold whitespace-nowrap text-amber-400">
                                PROMEDIO
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        >
                            ...
                            <td class="bg-amber-900/20 px-3 py-2 text-right text-sm font-bold whitespace-nowrap text-amber-400">
                                {{ formatearNumero(row.promedio) }}
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr class="bg-slate-800">
                            ...
                            <td class="bg-amber-900/50 px-3 py-3 text-right text-sm font-bold text-amber-400">
